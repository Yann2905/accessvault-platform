									...
									<div class="card mb-6 mb-xl-9">
										<div class="card-body pt-9 pb-0">
											...
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												<!--begin::Nav item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary py-5 me-6 active " href="{{ route('projet.acces.index', $projet->id) }}">Accès</a>
												</li>
												<!--begin::Nav item-->
												<li class="nav-item">
...
<!-- Modal d’ajout/modification du logo -->
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
			<script>
				$(document).on('click', '.btn-delete', function (e) {
					...
					let nomProjet = form.data('nom');

					Swal.fire({
						title: 'Êtes-vous sûr de vouloir supprimer ' + nomProjet + ' ?',
						...
						if (result.isConfirmed) {
							$.ajax({
								...
								error: function () {
									Swal.fire(
										'Erreur',
										'Impossible de supprimer ' + nomProjet,
										'error'
									);
								}
							});
