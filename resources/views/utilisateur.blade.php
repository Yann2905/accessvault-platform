...
<base href="../../../" />
		...
		<meta property="og:title" content="Page Utilisateurs" />
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-0">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Utilisateurs</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_660662b4939f0">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_660662b4939f0" data-allow-clear="true">
																<option></option>
										...
										<form action="{{ route('sign-up') }}" method="GET">
                                           @csrf
										    <button type="submit" class="btn btn-sm fw-bold btn-primary" >Crée un utilisateur </button>
										</form>
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
